...
@synthesize centredHUDFrameRect;
...
- (void)layoutSubviews {
    ...
    centredHUDFrameRect = CGRectMake((self.frame.size.width-totalSize.width)/2, (self.frame.size.height-totalSize.height)/2, totalSize.width, totalSize.height);
